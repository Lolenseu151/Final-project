...
public class LaserFX {
    ...
    public LaserFX(Rectangle r, float frameDuration) {
        ...
        loadSpriteSheet();
        Gdx.app.log("LaserFX", "Created LaserFX at (" + rect.x + ", " + rect.y + ") size: " + rect.width + "x" + rect.height);
    }
    ...
    public void setFrameDuration(float d) {
        ...
        Gdx.app.log("LaserFX", "Warning: Frame duration cannot be changed after animation creation. Use constructor with duration parameter.");
    }
        ...
        for (String path : paths) {
            try {
                ...
                if (fh.exists()) {
                    ...
                    Gdx.app.log("LaserFX", "Calculated frame size: " + frameWidth + "x" + frameHeight + " for " + frameCount + " frames");
                    ...
                    for (int i = 0; i < frameCount; i++) {
                        ...
                        frames.add(frame);
                        Gdx.app.log("LaserFX", "Created frame " + i + " at x=" + xPos + " size: " + frame.getRegionWidth() + "x" + frame.getRegionHeight());
                    }
                    ...
                    if (frames.size > 0) {
                        ...
                        Gdx.app.log("LaserFX", "Animation created with " + frames.size + " frames, duration: " + frameDuration);
                    } else {
    ...
    public void render(SpriteBatch batch) {
        if (animation != null && rect != null) {
            ...
            if (currentFrame != null) {
                ...
                Gdx.app.log("LaserFX", "Rendering frame " + frameIndex + " at time " + stateTime + " - region: " + currentFrame.getRegionWidth() + "x" + currentFrame.getRegionHeight());
