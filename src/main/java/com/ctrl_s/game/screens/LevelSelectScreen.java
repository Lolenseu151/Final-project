...
public class LevelSelectScreen implements Screen {
    ...
    // Temporary: enable hover logging and subtle tint fallback when hover drawable
    // appears identical
    private final boolean ENABLE_HOVER_DIAGNOSTICS = true;

    // Unified hover info list so polling works for all buttons (fixes touchpad
    // hover issues)
    private static class HoverInfo {
        ...
        HoverInfo(int id, ImageButton b, TextureRegionDrawable u, TextureRegionDrawable o) {
    ...
    public LevelSelectScreen(GameApplication game) {
        this.game = game;
    ...
    private void initializeUI() {
        ...
        String[] framePaths = new String[] { "backgrounds/2.png", "backgrounds/3.png", "backgrounds/4.png",
                "backgrounds/5.png",
                "backgrounds/6.png", "backgrounds/7.png", "backgrounds/8.png", "backgrounds/9.png",
                "backgrounds/10.png",
                "backgrounds/11.png", "backgrounds/12.png", "backgrounds/13.png" };
        ...
        for (String p : framePaths) {
            try {
                ...
                if (Gdx.files.internal("assets/" + p).exists())
                    fh = Gdx.files.internal("assets/" + p);
                else if (Gdx.files.absolute(userDir + "/assets/" + p).exists())
                    fh = Gdx.files.absolute(userDir + "/assets/" + p);
                if (fh != null) {
        ...
        // Load custom Level 1 button images (if present) - internal path first, then
        // project assets
        try {
            String btnBase = "assets/sprites/ui/buttons/level_selection/1.png";
            String btnHover = "assets/sprites/ui/buttons/level_selection/2.png";
            com.badlogic.gdx.files.FileHandle fh1 = null;
            com.badlogic.gdx.files.FileHandle fh2 = null;
            if (Gdx.files.internal(btnBase).exists())
                fh1 = Gdx.files.internal(btnBase);
            else if (Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnBase).exists())
                fh1 = Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnBase);
            if (Gdx.files.internal(btnHover).exists())
                fh2 = Gdx.files.internal(btnHover);
            else if (Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnHover).exists())
                fh2 = Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnHover);
            if (fh1 != null) {
        ...
        try {
            String btnBase2 = "assets/levels/level_2/1.png";
            String btnHover2 = "assets/levels/level_2/2.png";
            com.badlogic.gdx.files.FileHandle fh21 = null;
            com.badlogic.gdx.files.FileHandle fh22 = null;
            if (Gdx.files.internal(btnBase2).exists())
                fh21 = Gdx.files.internal(btnBase2);
            else if (Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnBase2).exists())
                fh21 = Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnBase2);
            if (Gdx.files.internal(btnHover2).exists())
                fh22 = Gdx.files.internal(btnHover2);
            else if (Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnHover2).exists())
                fh22 = Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnHover2);
            if (fh21 != null) {
        ...
        try {
            String btnBase3 = "assets/levels/level_3/1.png";
            String btnHover3 = "assets/levels/level_3/2.png";
            com.badlogic.gdx.files.FileHandle fh31 = null;
            com.badlogic.gdx.files.FileHandle fh32 = null;
            if (Gdx.files.internal(btnBase3).exists())
                fh31 = Gdx.files.internal(btnBase3);
            else if (Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnBase3).exists())
                fh31 = Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnBase3);
            if (Gdx.files.internal(btnHover3).exists())
                fh32 = Gdx.files.internal(btnHover3);
            else if (Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnHover3).exists())
                fh32 = Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnHover3);
            if (fh31 != null) {
        ...
        try {
            String btnBase4 = "assets/levels/level_4/1.png";
            String btnHover4 = "assets/levels/level_4/2.png";
            com.badlogic.gdx.files.FileHandle fh41 = null;
            com.badlogic.gdx.files.FileHandle fh42 = null;
            if (Gdx.files.internal(btnBase4).exists())
                fh41 = Gdx.files.internal(btnBase4);
            else if (Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnBase4).exists())
                fh41 = Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnBase4);
            if (Gdx.files.internal(btnHover4).exists())
                fh42 = Gdx.files.internal(btnHover4);
            else if (Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnHover4).exists())
                fh42 = Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnHover4);
            if (fh41 != null) {
        ...
        try {
            String btnBase5 = "assets/levels/level_5/1.png";
            String btnHover5 = "assets/levels/level_5/2.png";
            com.badlogic.gdx.files.FileHandle fh51 = null;
            com.badlogic.gdx.files.FileHandle fh52 = null;
            if (Gdx.files.internal(btnBase5).exists())
                fh51 = Gdx.files.internal(btnBase5);
            else if (Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnBase5).exists())
                fh51 = Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnBase5);
            if (Gdx.files.internal(btnHover5).exists())
                fh52 = Gdx.files.internal(btnHover5);
            else if (Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnHover5).exists())
                fh52 = Gdx.files.absolute(System.getProperty("user.dir") + "/" + btnHover5);
            if (fh51 != null) {
        ...
        try {
            String backBase = "assets/sprites/ui/buttons/back/7.png";
            String backHover = "assets/sprites/ui/buttons/back/8.png";
            com.badlogic.gdx.files.FileHandle fhb = null;
            com.badlogic.gdx.files.FileHandle fhbh = null;
            if (Gdx.files.internal(backBase).exists())
                fhb = Gdx.files.internal(backBase);
            else if (Gdx.files.absolute(userDir + "/" + backBase).exists())
                fhb = Gdx.files.absolute(userDir + "/" + backBase);
            if (Gdx.files.internal(backHover).exists())
                fhbh = Gdx.files.internal(backHover);
            else if (Gdx.files.absolute(userDir + "/" + backHover).exists())
                fhbh = Gdx.files.absolute(userDir + "/" + backHover);
            if (fhb != null) {
        ...
        try {
            String fontPath = "assets/fonts/bold/Bold.fnt";
            com.badlogic.gdx.files.FileHandle fh = null;
            if (Gdx.files.internal(fontPath).exists())
                fh = Gdx.files.internal(fontPath);
            else {
                String abs = userDir + "/" + fontPath;
                if (Gdx.files.absolute(abs).exists())
                    fh = Gdx.files.absolute(abs);
            }
            if (fh != null) {
    ...
    private ImageButton createBackButton(TextureRegion arrowRegion, TextureRegion arrowHoverRegion,
            float screenHeight) {
    ...
    private void createLevelButton(int levelNum, float x, float y) {
        ...
        ib.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                if (ENABLE_HOVER_DIAGNOSTICS) {
                    try {
                        ib.getImage().setColor(Color.WHITE);
                    } catch (Exception e) {
                    }
                }
        ...
        // For Level 1/2, if hover textures exist, keep references and use polling in
        // render()
        ...
        try {
            ...
            TextureRegionDrawable overDrawable = (ib.getStyle().imageOver != null)
                    ? (TextureRegionDrawable) ib.getStyle().imageOver
                    : upDrawable;
    ...
    public void render(float delta) {
        ...
        // Poll mouse position once and update all level hover states immediately (no
    ...
    // Helper: update hover state for an ImageButton using an existing
    // stage-coordinate point
    private boolean updateButtonHover(ImageButton ref, TextureRegionDrawable up, TextureRegionDrawable over,
            boolean wasHovered, com.badlogic.gdx.math.Vector2 stagePoint) {
        float bx = ref.getX();
        float by = ref.getY();
        float bw = ref.getWidth();
        float bh = ref.getHeight();
        boolean nowOver = (stagePoint.x >= bx && stagePoint.x <= bx + bw && stagePoint.y >= by
                && stagePoint.y <= by + bh);
        if (nowOver && !wasHovered) {
            ...
            try {
                ...
                if (ENABLE_HOVER_DIAGNOSTICS)
                    ref.getImage().setColor(Color.LIGHT_GRAY);
                ...
                if (ENABLE_HOVER_DIAGNOSTICS)
                    Gdx.app.log("[HoverDiag]",
                            "ENTER at " + (int) stagePoint.x + "," + (int) stagePoint.y + " for button " + ref);
            } catch (Exception e) {
            }
            return true;
            ...
            try {
                ...
                if (ENABLE_HOVER_DIAGNOSTICS)
                    ref.getImage().setColor(Color.WHITE);
                if (ENABLE_HOVER_DIAGNOSTICS)
                    Gdx.app.log("[HoverDiag]",
                            "EXIT at " + (int) stagePoint.x + "," + (int) stagePoint.y + " for button " + ref);
            } catch (Exception e) {
            }
            return false;
        }
