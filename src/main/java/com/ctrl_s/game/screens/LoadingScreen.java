...
public class LoadingScreen implements Screen {
    ...
    public LoadingScreen(GameApplication game) {
        this.game = game;
    ...
    public void render(float delta) {
        ...
        // After loading completes, go to MainMenuScreen
    ...
    private void loadBackgroundFrames() {
        ...
        // Updated paths to match assets/backgrounds/loading/
        String[] framePaths = {
                "backgrounds/loading/15.png",
                "backgrounds/loading/14.png",
                "backgrounds/loading/13.png",
                "backgrounds/loading/12.png",
                "backgrounds/loading/11.png",
                "backgrounds/loading/10.png",
                "backgrounds/loading/9.png",
                "backgrounds/loading/8.png",
                "backgrounds/loading/7.png",
                "backgrounds/loading/6.png",
                "backgrounds/loading/5.png",
                "backgrounds/loading/4.png",
                "backgrounds/loading/3.png",
                "backgrounds/loading/2.png",
                "backgrounds/loading/1.png"
        };
        ...
        if (regions.size > 0) {
            bgAnimation = new Animation<>(0.3f, regions, Animation.PlayMode.NORMAL); // Changed from 0.15f to 0.3f for
                                                                                     // slower animation
    ...
    private void drawText() {
        ...
        try {
            ...
            if (usingLocalFont && localFont != null)
                localFont.dispose();
        }
    }
    ...
    private void drawCharacters() {
        ...
        // This method will be used to animate and draw characters during the loading
        // screen
    }
    ...
    public void show() {
        ...
        // Removed preloading of missing tutorial images to prevent errors
        game.tutorialImages = null;
    }
