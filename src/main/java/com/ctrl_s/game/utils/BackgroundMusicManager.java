...
public class BackgroundMusicManager {
    ...
    // Screen music path
    private static final String SCREEN_MUSIC_PATH = "assets/audio/music/game_screen.mp3";
    ...
    private void playMusic(String musicPath, MusicType type) {
        ...
        try {
            ...
            if (currentMusic != null) {
                ...
                Gdx.app.log("BackgroundMusicManager",
                        "Started playing: " + musicPath + " (type: " + type + ") at volume: " + volume);
            } else {
