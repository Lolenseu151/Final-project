 ...
 */
public class LevelShredder { // Renamed from Shredder to avoid confusion
    ...
    public LevelShredder() {
        this.rect = new Rectangle(0, 0, 48, 48);
    }

    public LevelShredder(Rectangle r) {
    ...
    public void loadFromFolder(String folder, int maxFrames) {
        ...
        if (allRegs.size >= 2 && allRegs.get(1) != null)
            readyRegion = allRegs.get(1);
